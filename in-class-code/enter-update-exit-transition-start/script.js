...
function gotData(incomingData){
  ...
  function visualizeData(){
        ...
        let datagroups = vizGroup.selectAll(".datagroup").data(dataToShow,assignKeys); //keys!!! text update
        ...
        // exitingElements.attr("transform",getIncomingGroupLocation).transition().attr("Opacity",0).remove();
